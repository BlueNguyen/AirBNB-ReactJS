...
import LocationCreateButton from "../../Button/Create/Location/LocationCreateButton";
import { useLocation } from "react-router-dom";

const MobileSidebar = ({ toggleSideMenu }) => {
      ...
      {toggleSideMenu && (
        <aside className="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden">
            ...
            <ul>
              ...
              <li className="relative px-6 py-3">
                ...
                >
                  ...
                  <span className="ml-4">Vị trí</span>
                </a>
              </li>
          ...
          <li className="relative px-6 py-3">
            ...
            {pathname === "/admin/location" && <LocationCreateButton />}
          </div>
        </aside>
      )}
    </>
